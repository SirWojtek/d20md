...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return models.Monster.findAll({
      ...
      const data = _.flatMap(monsters, monster => {
        ...
        return jsonMonster.EnvironmentTags.map(tag => {
          return {
            ...tag,
      ...
      return queryInterface.bulkInsert('EnvironmentTags', data);
    });
  },
  ...
  down: (queryInterface, Sequelize) => {
    ...
    .then(records => {
      ...
      return queryInterface.bulkDelete('EnvironmentTags', { MonsterId: idsToDelete });
    });
  }
};
